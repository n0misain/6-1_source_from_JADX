...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable {
    ...
    class C11461 extends OutputStream {
        C11461() {
        }
    ...
    class C11472 extends InputStream {
        C11472() {
        }
    ...
    public int readUtf8CodePoint() throws EOFException {
        ...
        if ((b0 & 128) == 0) {
            ...
            byteCount = 2;
            min = 128;
        } else if ((b0 & TwitterApiErrorConstants.SPAMMER) == 224) {
            codePoint = b0 & 15;
            byteCount = 3;
            min = 2048;
        } else if ((b0 & 248) == TwitterApiErrorConstants.SPAMMER) {
            codePoint = b0 & 7;
            byteCount = 4;
            min = 65536;
        } else {
            ...
            while (i < endIndex) {
                ...
                if (c < 128) {
                    ...
                    if (c > 56319 || low < 56320 || low > 57343) {
                        ...
                        writeByte((codePoint >> 18) | TwitterApiErrorConstants.SPAMMER);
