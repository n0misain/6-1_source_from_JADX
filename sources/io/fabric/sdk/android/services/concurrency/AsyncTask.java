...
public abstract class AsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory threadFactory = new C10841();
    ...
    private final WorkerRunnable<Params, Result> worker = new C10852();

    /* renamed from: io.fabric.sdk.android.services.concurrency.AsyncTask$1 */
    static class C10841 implements ThreadFactory {
    ...
    class C10852 extends WorkerRunnable<Params, Result> {
        C10852() {
            super();
        }
