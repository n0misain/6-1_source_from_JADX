...
public class InstallerPackageNameProvider {
    ...
    private final ValueLoader<String> installerPackageNameLoader = new C10811();

    /* renamed from: io.fabric.sdk.android.services.common.InstallerPackageNameProvider$1 */
    class C10811 implements ValueLoader<String> {
        C10811() {
        }
    ...
    public String getInstallerPackageName(Context appContext) {
        try {
            ...
            Fabric.getLogger().mo4336e(Fabric.TAG, "Failed to determine installer package name", e);
            return null;
        }
    }
}
