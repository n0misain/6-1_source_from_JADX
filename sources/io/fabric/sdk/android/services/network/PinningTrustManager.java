...
class PinningTrustManager implements X509TrustManager {
    ...
    private void checkPinTrust(X509Certificate[] chain) throws CertificateException {
        ...
        Fabric.getLogger().mo4346w(Fabric.TAG, "Certificate pins are stale, (" + (System.currentTimeMillis() - this.pinCreationTimeMillis) + " millis vs " + PIN_FRESHNESS_DURATION_MILLIS + " millis) " + "falling back to system trust.");
    }
