...
public class Settings {
    ...
    public SettingsData awaitSettingsData() {
        try {
            ...
            Fabric.getLogger().mo4335e(Fabric.TAG, "Interrupted while waiting for settings data.");
            return null;
        }
    }
    ...
    public synchronized boolean loadSettingsSkippingCache() {
        ...
        if (settingsData == null) {
            Fabric.getLogger().mo4336e(Fabric.TAG, "Failed to force reload of settings from Crashlytics.", null);
        }
        return settingsData != null;
    }
