...
class DefaultCachedSettingsIo implements CachedSettingsIo {
    ...
    public JSONObject readCachedSettings() {
        Exception e;
        Throwable th;
        Fabric.getLogger().mo4333d(Fabric.TAG, "Reading cached settings...");
        ...
        try {
            ...
            if (settingsFile.exists()) {
                ...
                try {
                    ...
                    fis = fis2;
                    try {
                        Fabric.getLogger().mo4336e(Fabric.TAG, "Failed to fetch cached settings", e);
            ...
            Fabric.getLogger().mo4333d(Fabric.TAG, "No cached settings found.");
            CommonUtils.closeOrLog(fis, "Error while closing settings cache file.");
        } catch (Exception e3) {
            e = e3;
            Fabric.getLogger().mo4336e(Fabric.TAG, "Failed to fetch cached settings", e);
    ...
    public void writeCachedSettings(long expiresAtMillis, JSONObject settingsJson) {
        Exception e;
        Throwable th;
        Fabric.getLogger().mo4333d(Fabric.TAG, "Writing settings to cache file...");
        if (settingsJson != null) {
            ...
            try {
                ...
                try {
                    ...
                    writer = writer2;
                    try {
                        Fabric.getLogger().mo4336e(Fabric.TAG, "Failed to cache settings", e);
