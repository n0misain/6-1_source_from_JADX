...
final class OkHttpCall<T> implements Call<T> {
    ...
    Response<T> parseResponse(Response rawResponse) throws IOException {
        ...
        if (code < ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION || code >= TwitterApiErrorConstants.REGISTRATION_INVALID_INPUT) {
            try {
        ...
        } else if (code == AppLovinErrorCodes.NO_FILL || code == 205) {
            rawBody.close();
