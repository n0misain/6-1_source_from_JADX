...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new C01321();
    ...
    private final WorkerRunnable<Params, Result> mWorker = new C01332();

    /* renamed from: android.support.v4.content.ModernAsyncTask$1 */
    static class C01321 implements ThreadFactory {
    ...
    class C01332 extends WorkerRunnable<Params, Result> {
        C01332() {
        }
