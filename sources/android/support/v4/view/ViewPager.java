...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C02221();
    ...
    private static final Interpolator sInterpolator = new C02232();
    ...
    private final Runnable mEndScrollRunnable = new C02243();
    ...
    static class C02221 implements Comparator<ItemInfo> {
        C02221() {
        }
    ...
    static class C02232 implements Interpolator {
        C02232() {
        }
    ...
    class C02254 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect = new Rect();
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C02261());
        Parcelable adapterState;
        ClassLoader loader;
        int position;

        /* renamed from: android.support.v4.view.ViewPager$SavedState$1 */
        static class C02261 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C02261() {
            }
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C02254());
    }
