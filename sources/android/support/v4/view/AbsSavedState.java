...
public abstract class AbsSavedState implements Parcelable {
    public static final Creator<AbsSavedState> CREATOR = ParcelableCompat.newCreator(new C02112());
    public static final AbsSavedState EMPTY_STATE = new C02101();
    private final Parcelable mSuperState;

    /* renamed from: android.support.v4.view.AbsSavedState$1 */
    static class C02101 extends AbsSavedState {
        C02101() {
            super();
        }
    }
    ...
    static class C02112 implements ParcelableCompatCreatorCallbacks<AbsSavedState> {
        C02112() {
        }
