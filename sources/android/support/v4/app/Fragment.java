...
public class Fragment implements ComponentCallbacks, OnCreateContextMenuListener {
    ...
    class C01062 extends FragmentContainer {
        C01062() {
        }
    ...
    public static class SavedState implements Parcelable {
        public static final Creator<SavedState> CREATOR = new C01071();
        final Bundle mState;

        /* renamed from: android.support.v4.app.Fragment$SavedState$1 */
        static class C01071 implements Creator<SavedState> {
            C01071() {
            }
    ...
    public void startPostponedEnterTransition() {
        if (this.mFragmentManager == null || this.mFragmentManager.mHost == null) {
            ...
            this.mFragmentManager.mHost.getHandler().postAtFrontOfQueue(new C01051());
        } else {
    ...
    void instantiateChildFragmentManager() {
        ...
        this.mChildFragmentManager.attachController(this.mHost, new C01062(), this);
    }
