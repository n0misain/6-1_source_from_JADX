...
public class ListFragment extends Fragment {
    ...
    View mListContainer;
    boolean mListShown;
    private final OnItemClickListener mOnClickListener = new C01272();
    View mProgressContainer;
    private final Runnable mRequestFocus = new C01261();
    ...
    class C01272 implements OnItemClickListener {
        C01272() {
        }
