...
public class TransportMediator extends TransportController {
    ...
    class C01721 implements TransportMediatorCallback {
        C01721() {
        }
    ...
    class C01732 implements Callback {
        C01732() {
        }
    ...
    private TransportMediator(Activity activity, View view, TransportPerformer callbacks) {
        ...
        this.mTransportKeyCallback = new C01721();
        this.mKeyEventCallback = new C01732();
