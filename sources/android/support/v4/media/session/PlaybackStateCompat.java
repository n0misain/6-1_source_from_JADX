...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final Creator<PlaybackStateCompat> CREATOR = new C01941();
    ...
    static class C01941 implements Creator<PlaybackStateCompat> {
        C01941() {
        }
    ...
    public static final class CustomAction implements Parcelable {
        public static final Creator<CustomAction> CREATOR = new C01951();
        ...
        static class C01951 implements Creator<CustomAction> {
            C01951() {
            }
