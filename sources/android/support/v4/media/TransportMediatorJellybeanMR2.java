...
class TransportMediatorJellybeanMR2 {
    OnAudioFocusChangeListener mAudioFocusChangeListener = new C01774();
    boolean mAudioFocused;
    final AudioManager mAudioManager;
    final Context mContext;
    boolean mFocused;
    final OnGetPlaybackPositionListener mGetPlaybackPositionListener = new C01785();
    final Intent mIntent;
    final BroadcastReceiver mMediaButtonReceiver = new C01763();
    PendingIntent mPendingIntent;
    int mPlayState = 0;
    final OnPlaybackPositionUpdateListener mPlaybackPositionUpdateListener = new C01796();
    final String mReceiverAction;
    final IntentFilter mReceiverFilter;
    RemoteControlClient mRemoteControl;
    final View mTargetView;
    final TransportMediatorCallback mTransportCallback;
    final OnWindowAttachListener mWindowAttachListener = new C01741();
    final OnWindowFocusChangeListener mWindowFocusListener = new C01752();

    /* renamed from: android.support.v4.media.TransportMediatorJellybeanMR2$1 */
    class C01741 implements OnWindowAttachListener {
        C01741() {
        }
    ...
    class C01752 implements OnWindowFocusChangeListener {
        C01752() {
        }
    ...
    class C01763 extends BroadcastReceiver {
        C01763() {
        }
    ...
    class C01774 implements OnAudioFocusChangeListener {
        C01774() {
        }
    ...
    class C01785 implements OnGetPlaybackPositionListener {
        C01785() {
        }
    ...
    class C01796 implements OnPlaybackPositionUpdateListener {
        C01796() {
        }
