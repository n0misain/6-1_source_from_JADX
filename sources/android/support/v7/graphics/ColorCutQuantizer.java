...
final class ColorCutQuantizer {
    ...
    private static final Comparator<Vbox> VBOX_COMPARATOR_VOLUME = new C03041();
    final int[] mColors;
    ...
    static class C03041 implements Comparator<Vbox> {
        C03041() {
        }
    ...
    private class Vbox {
        ...
        final void fitBox() {
            ...
            int minBlue = ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED;
            int minGreen = ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED;
            int minRed = ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED;
