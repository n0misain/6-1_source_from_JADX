...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    static final int[] ATTRS = new int[]{C0302R.attr.actionBarSize, 16842841};
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C03381();
        this.mRemoveActionBarHideOffset = new C03392();
        this.mAddActionBarHideOffset = new C03403();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0302R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0302R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0302R.id.action_bar));
        }
    }
