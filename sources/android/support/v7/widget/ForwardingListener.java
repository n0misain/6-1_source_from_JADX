...
public abstract class ForwardingListener implements OnTouchListener {
    ...
    class C03631 implements OnAttachStateChangeListener {
        C03631() {
        }
    ...
    class C03642 implements OnGlobalLayoutListener {
    ...
    private void addDetachListenerApi12(View src) {
        src.addOnAttachStateChangeListener(new C03631());
    }

    private void addDetachListenerBase(View src) {
        src.getViewTreeObserver().addOnGlobalLayoutListener(new C03642());
    }
