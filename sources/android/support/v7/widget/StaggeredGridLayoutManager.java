...
public class StaggeredGridLayoutManager extends LayoutManager implements ScrollVectorProvider {
    ...
    private final Runnable mCheckForGapsRunnable = new C03991();
    ...
    static class LazySpanLookup {
        ...
        static class FullSpanItem implements Parcelable {
            public static final Creator<FullSpanItem> CREATOR = new C04001();
            int mGapDir;
            int[] mGapPerSpan;
            ...
            static class C04001 implements Creator<FullSpanItem> {
                C04001() {
                }
    ...
    public static class SavedState implements Parcelable {
        public static final Creator<SavedState> CREATOR = new C04011();
        ...
        static class C04011 implements Creator<SavedState> {
            C04011() {
            }
