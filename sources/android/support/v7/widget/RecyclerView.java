...
import android.support.v7.recyclerview.C0320R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    static final Interpolator sQuinticInterpolator = new C03783();
    ...
    public static abstract class LayoutManager {
        ...
        private final Callback mHorizontalBoundCheckCallback = new C03821();
        ...
        private final Callback mVerticalBoundCheckCallback = new C03832();
        private int mWidth;
        ...
        class C03832 implements Callback {
            C03832() {
            }
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0320R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0320R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C0320R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C0320R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C0320R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }
    ...
    static class C03783 implements Interpolator {
        C03783() {
        }
    ...
    class C03794 implements ProcessCallback {
        C03794() {
        }
    ...
    class C03805 implements Callback {
        C03805() {
        }
    ...
    class C03816 implements Callback {
        C03816() {
        }
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C03841());
        Parcelable mLayoutState;

        /* renamed from: android.support.v7.widget.RecyclerView$SavedState$1 */
        static class C03841 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C03841() {
            }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        this.mUpdateChildViewsRunnable = new C03761();
        ...
        this.mItemAnimatorRunner = new C03772();
        this.mViewInfoProcessCallback = new C03794();
        if (attrs != null) {
        ...
        if (attrs != null) {
            a = context.obtainStyledAttributes(attrs, C0320R.styleable.RecyclerView, defStyle, 0);
            String layoutManagerName = a.getString(C0320R.styleable.RecyclerView_layoutManager);
            if (a.getInt(C0320R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C03805());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C03816());
    }
