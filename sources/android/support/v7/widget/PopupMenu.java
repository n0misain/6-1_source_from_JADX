...
public class PopupMenu {
    ...
    class C03731 implements Callback {
        C03731() {
        }
    ...
    class C03742 implements android.widget.PopupWindow.OnDismissListener {
        C03742() {
        }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View anchor, int gravity) {
        this(context, anchor, gravity, C0302R.attr.popupMenuStyle, 0);
    }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View anchor, int gravity, @AttrRes int popupStyleAttr, @StyleRes int popupStyleRes) {
        ...
        this.mMenu.setCallback(new C03731());
        ...
        this.mPopup.setOnDismissListener(new C03742());
    }
