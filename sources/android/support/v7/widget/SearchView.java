...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C03904 implements OnFocusChangeListener {
        C03904() {
        }
    ...
    class C03915 implements OnLayoutChangeListener {
        C03915() {
        }
    ...
    class C03926 implements OnGlobalLayoutListener {
        C03926() {
        }
    ...
    class C03937 implements OnClickListener {
        C03937() {
        }
    ...
    class C03948 implements OnKeyListener {
        C03948() {
        }
    ...
    class C03959 implements OnEditorActionListener {
        C03959() {
        }
    ...
    static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C03961());
        boolean isIconified;

        /* renamed from: android.support.v7.widget.SearchView$SavedState$1 */
        static class C03961 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C03961() {
            }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attrs) {
            this(context, attrs, C0302R.attr.autoCompleteTextViewStyle);
        }
    ...
    public SearchView(Context context, AttributeSet attrs) {
        this(context, attrs, C0302R.attr.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mShowImeRunnable = new C03871();
        this.mUpdateDrawableStateRunnable = new C03882();
        this.mReleaseCursorRunnable = new C03893();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C03937();
        this.mTextKeyListener = new C03948();
        this.mOnEditorActionListener = new C03959();
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0302R.styleable.SearchView, defStyleAttr, 0);
        LayoutInflater.from(context).inflate(a.getResourceId(C0302R.styleable.SearchView_layout, C0302R.layout.abc_search_view), this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0302R.id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0302R.id.search_edit_frame);
        this.mSearchPlate = findViewById(C0302R.id.search_plate);
        this.mSubmitArea = findViewById(C0302R.id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0302R.id.search_button);
        this.mGoButton = (ImageView) findViewById(C0302R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0302R.id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0302R.id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0302R.id.search_mag_icon);
        ViewCompat.setBackground(this.mSearchPlate, a.getDrawable(C0302R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(this.mSubmitArea, a.getDrawable(C0302R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(a.getDrawable(C0302R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(a.getDrawable(C0302R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(a.getDrawable(C0302R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(a.getDrawable(C0302R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(a.getDrawable(C0302R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = a.getDrawable(C0302R.styleable.SearchView_searchHintIcon);
        this.mSuggestionRowLayout = a.getResourceId(C0302R.styleable.SearchView_suggestionRowLayout, C0302R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = a.getResourceId(C0302R.styleable.SearchView_commitIcon, 0);
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C03904());
        setIconifiedByDefault(a.getBoolean(C0302R.styleable.SearchView_iconifiedByDefault, true));
        int maxWidth = a.getDimensionPixelSize(C0302R.styleable.SearchView_android_maxWidth, -1);
        if (maxWidth != -1) {
            setMaxWidth(maxWidth);
        }
        this.mDefaultQueryHint = a.getText(C0302R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = a.getText(C0302R.styleable.SearchView_queryHint);
        int imeOptions = a.getInt(C0302R.styleable.SearchView_android_imeOptions, -1);
        if (imeOptions != -1) {
            setImeOptions(imeOptions);
        }
        int inputType = a.getInt(C0302R.styleable.SearchView_android_inputType, -1);
        if (inputType != -1) {
            setInputType(inputType);
        }
        setFocusable(a.getBoolean(C0302R.styleable.SearchView_android_focusable, true));
        a.recycle();
    ...
    private void addOnLayoutChangeListenerToDropDownAnchorSDK11() {
        this.mDropDownAnchor.addOnLayoutChangeListener(new C03915());
    }

    private void addOnLayoutChangeListenerToDropDownAnchorBase() {
        this.mDropDownAnchor.getViewTreeObserver().addOnGlobalLayoutListener(new C03926());
    }
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0302R.dimen.abc_search_view_preferred_width);
    }

    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(C0302R.dimen.abc_search_view_preferred_height);
    }
    ...
    void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int iconOffset = this.mIconifiedByDefault ? res.getDimensionPixelSize(C0302R.dimen.abc_dropdownitem_icon_width) + res.getDimensionPixelSize(C0302R.dimen.abc_dropdownitem_text_padding_left) : 0;
