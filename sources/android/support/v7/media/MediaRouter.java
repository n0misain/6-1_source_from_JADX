...
public final class MediaRouter {
    ...
    private static final class GlobalMediaRouter implements SyncCallback, android.support.v7.media.RegisteredMediaRouteProviderWatcher.Callback {
        ...
        private OnActiveChangeListener mSessionActiveListener = new C03081();
        ...
        class C03081 implements OnActiveChangeListener {
            C03081() {
            }
        ...
        private void updateSelectedRouteIfNeeded(boolean selectedRouteDescriptorChanged) {
            ...
            if (this.mSelectedRoute == null) {
                ...
                if (this.mSelectedRoute instanceof RouteGroup) {
                    ...
                    for (RouteInfo route2 : routes) {
                        idSet.add(route2.mDescriptorId);
                    }
                    ...
                    while (iter.hasNext()) {
                        ...
                        if (!idSet.contains(entry.getKey())) {
                            controller = (RouteController) entry.getValue();
                            controller.onUnselect();
                            controller.onRelease();
                            iter.remove();
                        }
                    }
                    for (RouteInfo route22 : routes) {
                        if (!this.mRouteControllerMap.containsKey(route22.mDescriptorId)) {
                            controller = route22.getProviderInstance().onCreateRouteController(route22.mDescriptorId, this.mSelectedRoute.mDescriptorId);
                            controller.onSelect();
                            this.mRouteControllerMap.put(route22.mDescriptorId, controller);
                        }
                    }
                }
            ...
            if (this.mSelectedRoute != route) {
                ...
                if (this.mSelectedRoute != null) {
                    ...
                    if (!this.mRouteControllerMap.isEmpty()) {
                        for (RouteController controller2 : this.mRouteControllerMap.values()) {
                ...
                if (this.mSelectedRoute != null) {
                    ...
                    if (this.mSelectedRoute instanceof RouteGroup) {
                        ...
                        for (RouteInfo r : routes) {
                            controller2 = r.getProviderInstance().onCreateRouteController(r.mDescriptorId, this.mSelectedRoute.mDescriptorId);
