...
abstract class SystemMediaRouteProvider extends MediaRouteProvider {
    ...
    static class JellybeanImpl extends SystemMediaRouteProvider implements Callback, VolumeCallback {
        ...
        public JellybeanImpl(Context context, SyncCallback syncCallback) {
            ...
            this.mUserRouteCategoryObj = MediaRouterJellybean.createRouteCategory(this.mRouterObj, context.getResources().getString(C0318R.string.mr_user_route_category_name), false);
            updateSystemRoutes();
        }
        ...
        protected Object getSystemRoute(RouteInfo route) {
            if (route == null) {
                return null;
            }
            int index = findSystemRouteRecordByDescriptorId(route.getDescriptorId());
            if (index >= 0) {
                return ((SystemRouteRecord) this.mSystemRouteRecords.get(index)).mRouteObj;
            }
            return null;
        }
    }
    ...
    static class LegacyImpl extends SystemMediaRouteProvider {
        ...
        void publishRoutes() {
            ...
            setDescriptor(new MediaRouteProviderDescriptor.Builder().addRoute(new Builder(SystemMediaRouteProvider.DEFAULT_ROUTE_ID, r.getString(C0318R.string.mr_system_route_name)).addControlFilters(CONTROL_FILTERS).setPlaybackStream(3).setPlaybackType(0).setVolumeHandling(1).setVolumeMax(maxVolume).setVolume(this.mLastReportedVolume).build()).build());
        }
