...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C02991();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C03002();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C03013();

    /* renamed from: android.support.v7.app.WindowDecorActionBar$1 */
    class C02991 extends ViewPropertyAnimatorListenerAdapter {
        C02991() {
        }
    ...
    class C03002 extends ViewPropertyAnimatorListenerAdapter {
        C03002() {
        }
    ...
    class C03013 implements ViewPropertyAnimatorUpdateListener {
        C03013() {
        }
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0302R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0302R.id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0302R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0302R.id.action_bar_container);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, C0302R.styleable.ActionBar, C0302R.attr.actionBarStyle, 0);
        if (a.getBoolean(C0302R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0302R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0302R.attr.actionBarWidgetTheme, outValue, true);
