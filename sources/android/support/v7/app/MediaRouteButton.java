...
public class MediaRouteButton extends View {
    ...
    public MediaRouteButton(Context context, AttributeSet attrs) {
        this(context, attrs, C0318R.attr.mediaRouteButtonStyle);
    }
    ...
    public MediaRouteButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0318R.styleable.MediaRouteButton, defStyleAttr, 0);
        this.mButtonTint = a.getColorStateList(C0318R.styleable.MediaRouteButton_buttonTint);
        setRemoteIndicatorDrawable(a.getDrawable(C0318R.styleable.MediaRouteButton_externalRouteEnabledDrawable));
        this.mMinWidth = a.getDimensionPixelSize(C0318R.styleable.MediaRouteButton_android_minWidth, 0);
        this.mMinHeight = a.getDimensionPixelSize(C0318R.styleable.MediaRouteButton_android_minHeight, 0);
        a.recycle();
    ...
    public boolean performLongClick() {
        ...
        Toast cheatSheet = Toast.makeText(context, C0318R.string.mr_button_content_description, 0);
    ...
    private void updateContentDescription() {
        int resId;
        if (this.mIsConnecting) {
            resId = C0318R.string.mr_cast_button_connecting;
        } else if (this.mRemoteActive) {
            resId = C0318R.string.mr_cast_button_connected;
        } else {
            resId = C0318R.string.mr_cast_button_disconnected;
        }
