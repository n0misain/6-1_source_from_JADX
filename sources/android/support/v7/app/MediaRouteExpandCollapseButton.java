...
class MediaRouteExpandCollapseButton extends ImageButton {
    ...
    public MediaRouteExpandCollapseButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mExpandAnimationDrawable = (AnimationDrawable) ContextCompat.getDrawable(context, C0318R.drawable.mr_group_expand);
        this.mCollapseAnimationDrawable = (AnimationDrawable) ContextCompat.getDrawable(context, C0318R.drawable.mr_group_collapse);
        ...
        this.mExpandGroupDescription = context.getString(C0318R.string.mr_controller_expand_group);
        this.mCollapseGroupDescription = context.getString(C0318R.string.mr_controller_collapse_group);
        setImageDrawable(this.mExpandAnimationDrawable.getFrame(0));
        setContentDescription(this.mExpandGroupDescription);
        super.setOnClickListener(new C02951());
    }
