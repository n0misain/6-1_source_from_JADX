...
class ToolbarActionBar extends ActionBar {
    ...
    private final OnMenuItemClickListener mMenuClicker = new C02982();
    private final Runnable mMenuInvalidator = new C02971();
    ...
    class C02982 implements OnMenuItemClickListener {
        C02982() {
        }
...
*/
    ...
    private void ensureListMenuPresenter(Menu menu) {
        if (this.mListMenuPresenter == null && (menu instanceof MenuBuilder)) {
            ...
            this.mListMenuPresenter = new ListMenuPresenter(context2, C0302R.layout.abc_list_menu_item_layout);
