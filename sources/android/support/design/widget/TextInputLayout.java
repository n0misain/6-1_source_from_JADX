    ...
    public void setErrorEnabled(boolean enabled) {
        if (this.mErrorEnabled != enabled) {
            ...
            if (enabled) {
                ...
                if (useDefaultColor) {
                    TextViewCompat.setTextAppearance(this.mErrorView, C0302R.style.TextAppearance_AppCompat_Caption);
        ...
        if (this.mCounterEnabled != enabled) {
            if (enabled) {
                ...
                try {
                    ...
                    TextViewCompat.setTextAppearance(this.mCounterView, C0302R.style.TextAppearance_AppCompat_Caption);
