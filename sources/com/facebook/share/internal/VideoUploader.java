...
public class VideoUploader {
    ...
    static class C08231 extends AccessTokenTracker {
        C08231() {
        }
    ...
    private static abstract class UploadWorkItemBase implements Runnable {
        ...
        private boolean attemptRetry(int errorCode) {
            ...
            VideoUploader.getHandler().postDelayed(new C08271(), (long) (((int) Math.pow(3.0d, (double) this.completedRetries)) * VideoUploader.RETRY_DELAY_UNIT_MS));
            return true;
        }
    ...
    private static class FinishUploadWorkItem extends UploadWorkItemBase {
        static final Set<Integer> transientErrorCodes = new C08241();

        /* renamed from: com.facebook.share.internal.VideoUploader$FinishUploadWorkItem$1 */
        static class C08241 extends HashSet<Integer> {
            C08241() {
    ...
    private static class StartUploadWorkItem extends UploadWorkItemBase {
        static final Set<Integer> transientErrorCodes = new C08251();

        /* renamed from: com.facebook.share.internal.VideoUploader$StartUploadWorkItem$1 */
        static class C08251 extends HashSet<Integer> {
            C08251() {
    ...
    private static class TransferChunkWorkItem extends UploadWorkItemBase {
        static final Set<Integer> transientErrorCodes = new C08261();
        ...
        static class C08261 extends HashSet<Integer> {
            C08261() {
