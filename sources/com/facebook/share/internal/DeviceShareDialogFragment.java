...
public class DeviceShareDialogFragment extends DialogFragment {
    ...
    class C07932 implements Callback {
        C07932() {
        }
    ...
    class C07943 implements Runnable {
        C07943() {
        }
    ...
    private static class RequestState implements Parcelable {
        public static final Creator<RequestState> CREATOR = new C07951();
        private long expiresIn;
        private String userCode;

        /* renamed from: com.facebook.share.internal.DeviceShareDialogFragment$RequestState$1 */
        static class C07951 implements Creator<RequestState> {
            C07951() {
            }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = getActivity().getLayoutInflater().inflate(C0665R.layout.com_facebook_device_auth_dialog_fragment, null);
        ...
        ((Button) view.findViewById(C0665R.id.cancel_button)).setOnClickListener(new C07921());
        ((TextView) view.findViewById(C0665R.id.com_facebook_device_auth_instructions)).setText(Html.fromHtml(getString(C0665R.string.com_facebook_device_auth_instructions)));
    ...
    private void startShare() {
        ...
        new GraphRequest(null, DEVICE_SHARE_ENDPOINT, parameters, HttpMethod.POST, new C07932()).executeAsync();
    }
    ...
    private void setCurrentRequestState(RequestState currentRequestState) {
        ...
        this.codeExpiredFuture = getBackgroundExecutor().schedule(new C07943(), currentRequestState.getExpiresIn(), TimeUnit.SECONDS);
    }
}
