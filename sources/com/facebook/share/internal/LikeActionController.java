...
public class LikeActionController {
    ...
    static class C07983 implements Callback {
        C07983() {
        }
    ...
    static class C08005 extends AccessTokenTracker {
        C08005() {
        }
    ...
    class C08069 implements RequestCompletionCallback {
        C08069() {
        }
    ...
    private abstract class AbstractRequestWrapper implements RequestWrapper {
        ...
        class C08071 implements GraphRequest.Callback {
            C08071() {
            }
        ...
        protected void setRequest(GraphRequest request) {
            ...
            request.setCallback(new C08071());
        }
...
*/
    ...
    private static synchronized void performFirstInitialize() {
        synchronized (LikeActionController.class) {
            if (!isInitialized) {
                ...
                CallbackManagerImpl.registerStaticCallback(RequestCodeOffset.Like.toRequestCode(), new C07983());
                isInitialized = true;
            }
        }
    }
    ...
    private void refreshStatusAsync() {
        if (AccessToken.getCurrentAccessToken() == null) {
            ...
            fetchVerifiedObjectId(new C08069());
        }
    }
