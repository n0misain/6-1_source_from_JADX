...
public final class ShareInternalUtility {
    ...
    static class C08195 implements Mapper<Attachment, String> {
        C08195() {
        }
    ...
    static class C08228 implements PhotoJSONProcessor {
        C08228() {
        }
    ...
    public static List<String> getPhotoUrls(SharePhotoContent photoContent, final UUID appCallId) {
        if (photoContent != null) {
            ...
            if (photos != null) {
                ...
                List<String> attachmentUrls = Utility.map(attachments, new C08195());
    ...
    public static JSONObject toJSONObjectForWeb(ShareOpenGraphContent shareOpenGraphContent) throws JSONException {
        return OpenGraphJSONUtility.toJSONObject(shareOpenGraphContent.getAction(), new C08228());
    }
