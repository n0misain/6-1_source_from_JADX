...
public final class ShareApi {
    ...
    class C07897 implements ValueMapper {
        C07897() {
        }
        ...
        try {
            for (SharePhoto photo : photoContent.getPhotos()) {
                try {
                    ...
                    if (bitmap != null) {
                        arrayList = requests;
                        arrayList.add(GraphRequest.newUploadPhotoRequest(accessToken, getGraphPath("photos"), bitmap, caption, params, requestCallback));
                    } else if (photoUri != null) {
                        arrayList = requests;
                        arrayList.add(GraphRequest.newUploadPhotoRequest(accessToken, getGraphPath("photos"), photoUri, caption, params, requestCallback));
                    }
                } catch (Exception e) {
    ...
    private <T> void stageCollectionValues(CollectionMapper.Collection<T> collection, OnMapperCompleteListener onCollectionValuesStagedListener) {
        CollectionMapper.iterate(collection, new C07897(), onCollectionValuesStagedListener);
    }
