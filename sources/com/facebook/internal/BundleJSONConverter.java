...
public class BundleJSONConverter {
    ...
    static class C06961 implements Setter {
        C06961() {
        }
    ...
    static class C06972 implements Setter {
        C06972() {
        }
    ...
    static class C06983 implements Setter {
        C06983() {
        }
    ...
    static class C06994 implements Setter {
        C06994() {
        }
    ...
    static class C07005 implements Setter {
        C07005() {
        }
    ...
    static class C07016 implements Setter {
        C07016() {
        }
    ...
    static class C07027 implements Setter {
        C07027() {
        }
    ...
    static {
        SETTERS.put(Boolean.class, new C06961());
        SETTERS.put(Integer.class, new C06972());
        SETTERS.put(Long.class, new C06983());
        SETTERS.put(Double.class, new C06994());
        SETTERS.put(String.class, new C07005());
        SETTERS.put(String[].class, new C07016());
        SETTERS.put(JSONArray.class, new C07027());
    }
