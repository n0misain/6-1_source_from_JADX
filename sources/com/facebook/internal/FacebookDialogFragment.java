...
public class FacebookDialogFragment extends DialogFragment {
    ...
    class C07051 implements OnCompleteListener {
        C07051() {
        }
    ...
    class C07062 implements OnCompleteListener {
        C07062() {
        }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (this.dialog == null) {
            ...
            if (params.getBoolean(NativeProtocol.WEB_DIALOG_IS_FALLBACK, false)) {
                ...
                webDialog.setOnCompleteListener(new C07062());
            } else {
                ...
                webDialog = new Builder(activity, actionName, webParams).setOnCompleteListener(new C07051()).build();
            }
