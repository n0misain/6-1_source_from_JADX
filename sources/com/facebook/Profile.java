...
public final class Profile implements Parcelable {
    public static final Creator<Profile> CREATOR = new C06622();
    ...
    static class C06611 implements GraphMeRequestWithCacheCallback {
        C06611() {
        }
    ...
    static class C06622 implements Creator {
        C06622() {
        }
    ...
    public static void fetchProfileForCurrentAccessToken() {
        ...
        if (accessToken == null) {
            ...
            Utility.getGraphMeRequestWithCacheAsync(accessToken.getToken(), new C06611());
        }
    }
