...
public class LoginFragment extends Fragment {
    ...
    class C07491 implements OnCompletedListener {
        C07491() {
        }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.loginClient.setOnCompletedListener(new C07491());
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View view = inflater.inflate(C0665R.layout.com_facebook_login_fragment, container, false);
        this.loginClient.setBackgroundProcessingListener(new BackgroundProcessingListener() {
            public void onBackgroundProcessingStarted() {
                view.findViewById(C0665R.id.com_facebook_login_activity_progress_bar).setVisibility(0);
            }

            public void onBackgroundProcessingStopped() {
                view.findViewById(C0665R.id.com_facebook_login_activity_progress_bar).setVisibility(8);
            }
        });
        return view;
    }
    ...
    public void onPause() {
        super.onPause();
        getActivity().findViewById(C0665R.id.com_facebook_login_activity_progress_bar).setVisibility(8);
    }
