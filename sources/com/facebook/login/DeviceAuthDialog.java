...
public class DeviceAuthDialog extends DialogFragment {
    ...
    class C07321 implements Callback {
        C07321() {
        }
    ...
    class C07343 implements Runnable {
        C07343() {
        }
    ...
    class C07354 implements Callback {
        C07354() {
        }
    ...
    class C07365 implements DialogInterface.OnClickListener {
        C07365() {
        }
    ...
    private static class RequestState implements Parcelable {
        public static final Creator<RequestState> CREATOR = new C07391();
        ...
        static class C07391 implements Creator<RequestState> {
            C07391() {
            }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        this.dialog = new Dialog(getActivity(), C0665R.style.com_facebook_auth_dialog);
    ...
    public void startLogin(Request request) {
        ...
        new GraphRequest(null, DEVICE_LOGIN_ENDPOINT, parameters, HttpMethod.POST, new C07321()).executeAsync();
    }
    ...
    private View initializeContentView(boolean isSmartLogin) {
        ...
        if (isSmartLogin) {
            view = inflater.inflate(C0665R.layout.com_facebook_smart_device_dialog_fragment, null);
        } else {
            view = inflater.inflate(C0665R.layout.com_facebook_device_auth_dialog_fragment, null);
        }
        this.progressBar = (ProgressBar) view.findViewById(C0665R.id.progress_bar);
        this.confirmationCode = (TextView) view.findViewById(C0665R.id.confirmation_code);
        ((Button) view.findViewById(C0665R.id.cancel_button)).setOnClickListener(new C07332());
        this.instructions = (TextView) view.findViewById(C0665R.id.com_facebook_device_auth_instructions);
        this.instructions.setText(Html.fromHtml(getString(C0665R.string.com_facebook_device_auth_instructions)));
        return view;
    }
    ...
    private void schedulePoll() {
        this.scheduledPoll = DeviceAuthMethodHandler.getBackgroundExecutor().schedule(new C07343(), this.currentRequestState.getInterval(), TimeUnit.SECONDS);
    }

    private GraphRequest getPollRequest() {
        Bundle parameters = new Bundle();
        parameters.putString("code", this.currentRequestState.getRequestCode());
        return new GraphRequest(null, DEVICE_LOGIN_STATUS_ENDPOINT, parameters, HttpMethod.POST, new C07354());
    }
    ...
    private void presentConfirmation(final String userId, final PermissionsPair permissions, final String accessToken, String name) {
        String message = getResources().getString(C0665R.string.com_facebook_smart_login_confirmation_title);
        String continueFormat = getResources().getString(C0665R.string.com_facebook_smart_login_confirmation_continue_as);
        String cancel = getResources().getString(C0665R.string.com_facebook_smart_login_confirmation_cancel);
        ...
        }).setPositiveButton(cancel, new C07365());
        builder.create().show();
    }
