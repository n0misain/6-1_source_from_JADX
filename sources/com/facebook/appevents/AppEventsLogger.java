...
public class AppEventsLogger {
    ...
    static class C06804 implements Runnable {
        C06804() {
        }
    ...
    static class PersistedAppSessionInfo {
        ...
        private static final Runnable appSessionInfoFlushRunnable = new C06811();
    ...
    private static void initializeTimersIfNeeded() {
        synchronized (staticLock) {
            ...
            backgroundExecutor.scheduleAtFixedRate(new C06804(), 0, 86400, TimeUnit.SECONDS);
        }
    }
