...
public class DeviceRequestsHelper {
    ...
    public static Bitmap generateQRCode(String url) {
        ...
        try {
            BitMatrix matrix = new MultiFormatWriter().encode(url, BarcodeFormat.QR_CODE, Callback.DEFAULT_DRAG_ANIMATION_DURATION, Callback.DEFAULT_DRAG_ANIMATION_DURATION, hints);
