...
class BitmapHunter implements Runnable {
    ...
    private static final RequestHandler ERRORING_HANDLER = new C09802();
    private static final ThreadLocal<StringBuilder> NAME_BUILDER = new C09791();
    ...
    static class C09791 extends ThreadLocal<StringBuilder> {
        C09791() {
        }
    ...
    static class C09802 extends RequestHandler {
        C09802() {
        }
