...
public interface AppLovinMediationAdapter {
    ...
    void showIncentivizedAd(AppLovinMediatedAdInfo appLovinMediatedAdInfo, AppLovinMediationAdapterConfig appLovinMediationAdapterConfig, String str, Activity activity, AppLovinMediationDisplayListener appLovinMediationDisplayListener);

    void showInterstitialAd(AppLovinMediatedAdInfo appLovinMediatedAdInfo, AppLovinMediationAdapterConfig appLovinMediationAdapterConfig, String str, Activity activity, AppLovinMediationDisplayListener appLovinMediationDisplayListener);
}
