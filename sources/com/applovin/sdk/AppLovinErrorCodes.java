...
public class AppLovinErrorCodes {
    ...
    public static final int MEDIATION_ADAPTER_LOAD_FAILED_ON_RENDER = -5002;
    public static final int MEDIATION_ADAPTER_READY_AD = -5104;
    public static final int MEDIATION_ADAPTER_RENDER_NOT_READY_AD = -5003;
