...
class DefaultIndicatorController implements IndicatorController {
    ...
    public View newInstance(@NonNull Context context) {
        ...
        this.mDotLayout = (LinearLayout) View.inflate(context, C0864R.layout.default_indicator, null);
    ...
    public void initialize(int slideCount) {
        ...
        for (int i = 0; i < slideCount; i++) {
            ...
            dot.setImageDrawable(ContextCompat.getDrawable(this.mContext, C0864R.drawable.indicator_dot_grey));
    ...
    public void selectPosition(int index) {
        ...
        while (i < this.mSlideCount) {
            Drawable drawable = ContextCompat.getDrawable(this.mContext, i == index ? C0864R.drawable.indicator_dot_white : C0864R.drawable.indicator_dot_grey);
