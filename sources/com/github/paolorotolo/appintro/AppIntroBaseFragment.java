...
public abstract class AppIntroBaseFragment extends Fragment implements ISlideSelectionListener, ISlideBackgroundColorHolder {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        TextView t = (TextView) v.findViewById(C0864R.id.title);
        TextView d = (TextView) v.findViewById(C0864R.id.description);
        ImageView i = (ImageView) v.findViewById(C0864R.id.image);
        this.mainLayout = (LinearLayout) v.findViewById(C0864R.id.main);
        t.setText(this.title);
        if (this.titleColor != 0) {
            t.setTextColor(this.titleColor);
        }
        if (!(this.titleTypeface == null || CustomFontCache.get(this.titleTypeface, getContext()) == null)) {
        ...
        if (!(this.descTypeface == null || CustomFontCache.get(this.descTypeface, getContext()) == null)) {
