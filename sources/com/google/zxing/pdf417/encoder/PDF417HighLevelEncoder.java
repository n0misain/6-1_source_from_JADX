...
final class PDF417HighLevelEncoder {
    ...
    private static void encodeNumeric(String msg, int startpos, int count, StringBuilder sb) {
        ...
        while (idx < count) {
            ...
            BigInteger bigint = new BigInteger(new StringBuilder(AppEventsConstants.EVENT_PARAM_VALUE_YES).append(msg.substring(startpos + idx, (startpos + idx) + len)).toString());
            do {
