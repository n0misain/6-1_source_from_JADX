...
final class EANManufacturerOrgSupport {
    ...
    private synchronized void initIfNeeded() {
        if (this.ranges.isEmpty()) {
            ...
            add(new int[]{60, Errors.ALREADY_FAVORITED}, "US/CA");
            add(new int[]{TwitterApiErrorConstants.REGISTRATION_INVALID_INPUT, 379}, "FR");
            add(new int[]{380}, "BG");
            add(new int[]{383}, "SI");
            add(new int[]{385}, "HR");
            add(new int[]{387}, "BA");
            ...
            add(new int[]{AppLovinSdk.VERSION_CODE, 709}, "NO");
            add(new int[]{729}, "IL");
