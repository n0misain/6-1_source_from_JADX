...
public final class Code39Reader extends OneDReader {
    ...
    static {
        int[] iArr = new int[]{52, 289, 97, 352, 49, 304, 112, 37, 292, 100, 265, 73, 328, 25, 280, 88, 13, 268, 76, 28, CallbackHandler.MSG_ROUTE_CHANGED, 67, 322, 19, 274, 82, 7, CallbackHandler.MSG_ROUTE_SELECTED, 70, 22, 385, 193, 448, 145, 400, 208, 133, 388, 196, 148, 168, 162, 138, 42};
    ...
    public Result decodeRow(int rowNumber, BitArray row, Map<DecodeHintType, ?> map) throws NotFoundException, ChecksumException, FormatException {
        ...
        if (nextStart == end || (whiteSpaceAfterEnd << 1) >= lastPatternSize) {
            if (this.usingCheckDigit) {
                ...
                int total = 0;
                for (int i = 0; i < max; i++) {
                    total += CHECK_DIGIT_STRING.indexOf(this.decodeRowResult.charAt(i));
                }
