...
public class DatabaseError {
    ...
    public static DatabaseError zzZ(String str, String str2) {
        Integer num = (Integer) zzbYJ.get(str.toLowerCase());
        Integer valueOf = num == null ? Integer.valueOf(UNKNOWN_ERROR) : num;
        return new DatabaseError(valueOf.intValue(), str2 == null ? (String) zzbYI.get(valueOf) : str2, null);
    }
    ...
    public static DatabaseError zzgA(String str) {
        Integer num = (Integer) zzbYJ.get(str.toLowerCase());
        Integer valueOf = num == null ? Integer.valueOf(UNKNOWN_ERROR) : num;
        return new DatabaseError(valueOf.intValue(), (String) zzbYI.get(valueOf), null);
    }
