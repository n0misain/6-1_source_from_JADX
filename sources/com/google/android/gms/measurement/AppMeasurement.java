...
public class AppMeasurement {
    ...
    public static final class UserProperty extends com.google.firebase.analytics.FirebaseAnalytics.UserProperty {
        ...
        public static final String[] zzbom = new String[]{"firebase_last_notification", "first_open_time", "first_visit_time", "last_deep_link_referrer", AccessToken.USER_ID_KEY, "first_open_after_install"};
    ...
    public final void logEvent(@Size(max = 40, min = 1) @NonNull String str, Bundle bundle) {
        ...
        this.zzboe.zzwt().zza(SettingsJsonConstants.APP_KEY, str, bundle, true);
    }
