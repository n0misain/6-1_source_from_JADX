...
public final class zzac {
    ...
    final void zza(Context context, zzaje zzaje, boolean z, @Nullable zzafj zzafj, String str, @Nullable String str2, @Nullable Runnable runnable) {
        Object obj;
        if (zzafj == null) {
            obj = 1;
        } else {
            obj = ((((zzbs.zzbF().currentTimeMillis() - zzafj.zzhi()) > ((Long) zzbs.zzbL().zzd(zzmo.zzFQ)).longValue() ? 1 : ((zzbs.zzbF().currentTimeMillis() - zzafj.zzhi()) == ((Long) zzbs.zzbL().zzd(zzmo.zzFQ)).longValue() ? 0 : -1)) > 0 ? 1 : null) == null && zzafj.zzhj()) ? null : 1;
        }
        if (obj != null) {
            if (context == null) {
