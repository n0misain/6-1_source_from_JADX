...
public final class zzap extends Thread implements OnFrameAvailableListener, zzao {
    ...
    private final boolean zzgi() {
        ...
        if (!(this.zzQq == null || this.zzQq == EGL10.EGL_NO_SURFACE)) {
            z = (this.zzQn.eglMakeCurrent(this.zzQo, EGL10.EGL_NO_SURFACE, EGL10.EGL_NO_SURFACE, EGL10.EGL_NO_CONTEXT) | 0) | this.zzQn.eglDestroySurface(this.zzQo, this.zzQq);
            this.zzQq = null;
        }
        if (this.zzQp != null) {
        ...
        z |= this.zzQn.eglTerminate(this.zzQo);
        this.zzQo = null;
        return z;
    }
    ...
    public final void run() {
        int i = 1;
        if (this.zzQg == null) {
            zzajc.m1216e("SphericalVideoProcessor started with no output texture.");
            this.zzQl.countDown();
            return;
        }
        boolean z;
            ...
            if (this.zzQn.eglInitialize(this.zzQo, new int[2])) {
                ...
                if (eGLConfig == null) {
                    ...
                    if (this.zzQp == null || this.zzQp == EGL10.EGL_NO_CONTEXT) {
                        ...
                        this.zzQq = this.zzQn.eglCreateWindowSurface(this.zzQo, eGLConfig, this.zzQg, null);
        ...
        if (zzc == 0) {
            ...
            if (zzc2 == 0) {
                ...
                zzar("createProgram");
                if (i2 != 0) {
                    GLES20.glAttachShader(i2, zzc);
                    zzar("attachShader");
                    GLES20.glAttachShader(i2, zzc2);
                    zzar("attachShader");
        ...
        if (!z || r4 == 0) {
            ...
            zzbs.zzbD().zza(new Throwable(valueOf), "SphericalVideoProcessor.run.1");
            zzgi();
            this.zzQl.countDown();
            return;
        }
        this.zzQf = new SurfaceTexture(i2);
        ...
        try {
            ...
            while (!this.zzQs) {
                ...
                if (this.zzQr) {
                    ...
                    zzar("viewport");
                    i2 = GLES20.glGetUniformLocation(this.zzQh, "uFOVx");
                    int glGetUniformLocation = GLES20.glGetUniformLocation(this.zzQh, "uFOVy");
                    if (this.zzrW > this.zzrX) {
                        GLES20.glUniform1f(i2, 0.87266463f);
                        GLES20.glUniform1f(glGetUniformLocation, (((float) this.zzrX) * 0.87266463f) / ((float) this.zzrW));
                    } else {
                        GLES20.glUniform1f(i2, (((float) this.zzrW) * 0.87266463f) / ((float) this.zzrX));
            ...
            zzajc.zzaT("SphericalVideoProcessor halted unexpectedly.");
        } catch (Throwable th) {
            zzajc.zzb("SphericalVideoProcessor died.", th);
