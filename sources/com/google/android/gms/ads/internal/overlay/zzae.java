...
public final class zzae extends FrameLayout implements OnClickListener {
    ...
    public zzae(Context context, zzaf zzaf, zzaj zzaj) {
        ...
        View view = this.zzPG;
        zzji.zzds();
        zzc2 = zzaiy.zzc(context, (zzaf.size + zzaf.paddingLeft) + zzaf.paddingRight);
        zzji.zzds();
        addView(view, new LayoutParams(zzc2, zzaiy.zzc(context, zzaf.size + zzaf.paddingBottom), 17));
    }
