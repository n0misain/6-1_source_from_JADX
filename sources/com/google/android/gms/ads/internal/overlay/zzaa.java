...
public final class zzaa extends FrameLayout implements zzx {
    ...
    public zzaa(Context context, zzaka zzaka, int i, boolean z, zznb zznb, zzaq zzaq) {
        ...
        if (this.zzPs != null) {
            this.zzPs.zzh("spinner_used", this.zzPz ? AppEventsConstants.EVENT_PARAM_VALUE_YES : AppEventsConstants.EVENT_PARAM_VALUE_NO);
        }
    ...
    public final void zzd(int i, int i2) {
        if (this.zzPz) {
            ...
            if (this.zzPC == null || this.zzPC.getWidth() != max || this.zzPC.getHeight() != max2) {
                this.zzPC = Bitmap.createBitmap(max, max2, Config.ARGB_8888);
                this.zzPE = false;
            }
        }
    }
    ...
    public final void zzfX() {
        ...
        if (this.zzPC != null) {
            ...
            elapsedRealtime = zzbs.zzbF().elapsedRealtime() - elapsedRealtime;
            if (zzafr.zzhM()) {
                zzafr.m1217v("Spinner frame grab took " + elapsedRealtime + "ms");
            }
            if (elapsedRealtime > this.zzPu) {
                zzajc.zzaT("Spinner frame grab crossed jank threshold! Suspending spinner.");
                this.zzPz = false;
                this.zzPC = null;
                if (this.zzPs != null) {
                    this.zzPs.zzh("spinner_jank", Long.toString(elapsedRealtime));
                }
            }
        }
    }
    ...
    public final void zzgb() {
        if (this.zzPv != null) {
            View textView = new TextView(this.zzPv.getContext());
            String str = "AdMob - ";
