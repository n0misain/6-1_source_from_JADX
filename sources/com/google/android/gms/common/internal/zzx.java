...
public final class zzx extends zza {
    ...
    zzx(int i, int i2, int i3, String str, IBinder iBinder, Scope[] scopeArr, Bundle bundle, Account account, zzc[] zzcArr) {
        ...
        if (i < 2) {
            if (iBinder != null) {
                ...
                if (iBinder != null) {
                    ...
                    zzan = queryLocalInterface instanceof zzal ? (zzal) queryLocalInterface : new zzan(iBinder);
                }
                account2 = zza.zza(zzan);
            }
            this.zzaHA = account2;
        } else {
            this.zzaHx = iBinder;
