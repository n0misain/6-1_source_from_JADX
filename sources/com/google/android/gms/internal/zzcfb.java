...
public final class zzcfb {
    ...
    public static zzcfc<Long> zzbqB = zzcfc.zzb("measurement.service_client.idle_disconnect_millis", 5000, 5000);
    ...
    public static zzcfc<Integer> zzbqf = zzcfc.zzm("measurement.upload.max_events_per_day", 100000, 100000);
    ...
    public static zzcfc<Integer> zzbqk = zzcfc.zzm("measurement.store.max_stored_events_per_app", 100000, 100000);
    ...
    public static zzcfc<Long> zzbqs = zzcfc.zzb("measurement.alarm_manager.minimum_interval", 60000, 60000);
