...
public final class so {
    ...
    private final List<vk> zza(tx txVar, uv<sn> uvVar, xm xmVar, ts tsVar) {
        ...
        List<vk> arrayList = new ArrayList();
    ...
    private final void zza(vt vtVar, vu vuVar) {
        qr zzFq = vtVar.zzFq();
        th zze = zze(vtVar);
        Object tfVar = new tf(this, vuVar);
    ...
    private final List<vk> zzb(tx txVar, uv<sn> uvVar, xm xmVar, ts tsVar) {
        sn snVar = (sn) uvVar.getValue();
        xm zzr = (xmVar != null || snVar == null) ? xmVar : snVar.zzr(qr.zzGZ());
        List<vk> arrayList = new ArrayList();
        uvVar.zzHS().zza(new su(this, zzr, tsVar, txVar, arrayList));
        if (snVar != null) {
            arrayList.addAll(snVar.zza(txVar, tsVar, zzr));
        }
        return arrayList;
    }
    ...
    public final xm zzc(qr qrVar, List<Long> list) {
        ...
        while (true) {
            wp zzHc = qrVar2.zzHc();
            qr zzHd = qrVar2.zzHd();
            qrVar2 = zzGZ.zza(zzHc);
            qr zza = qr.zza(qrVar2, qrVar);
            uvVar2 = zzHc != null ? uvVar2.zze(zzHc) : uv.zzHR();
            sn snVar = (sn) uvVar2.getValue();
            zzr = snVar != null ? snVar.zzr(zza) : xmVar;
            if (!zzHd.isEmpty() && zzr == null) {
                xmVar = zzr;
                zzGZ = qrVar2;
                qrVar2 = zzHd;
            }
        }
        return this.zzceH.zza(qrVar, zzr, (List) list, true);
    }
