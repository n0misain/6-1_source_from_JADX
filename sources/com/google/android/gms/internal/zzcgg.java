...
public final class zzcgg extends zzchj {
    ...
    public final <V> Future<V> zze(Callable<V> callable) throws IllegalStateException {
        zzkD();
        zzbo.zzu(callable);
        zzcgj zzcgj = new zzcgj(this, (Callable) callable, false, "Task exception on worker thread");
    ...
    public final <V> Future<V> zzf(Callable<V> callable) throws IllegalStateException {
        zzkD();
        zzbo.zzu(callable);
        zzcgj zzcgj = new zzcgj(this, (Callable) callable, true, "Task exception on worker thread");
        if (Thread.currentThread() == this.zzbrW) {
            zzcgj.run();
        } else {
            zza(zzcgj);
