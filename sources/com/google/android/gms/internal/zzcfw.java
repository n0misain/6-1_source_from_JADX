...
final class zzcfw extends zzchj {
    ...
    final String zzec(String str) {
        ...
        if (zzcjl.zzbE(CommonUtils.MD5_INSTANCE) == null) {
            return null;
        }
        return String.format(Locale.US, "%032X", new Object[]{new BigInteger(1, zzcjl.zzbE(CommonUtils.MD5_INSTANCE).digest(str2.getBytes()))});
    }
