...
final class ot implements oy {
    ...
    public final void zzC(Map<String, Object> map) {
        ...
        this.zzcbf.zzbZE.zzb(new StringBuilder((String.valueOf(str).length() + 26) + String.valueOf(str2).length()).append("Authentication failed: ").append(str).append(" (").append(str2).append(")").toString(), null, new Object[0]);
