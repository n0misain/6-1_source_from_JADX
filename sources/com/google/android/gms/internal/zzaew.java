...
public final class zzaew {
    ...
    private final Object zza(String str, Context context) {
        ...
        if (zza(context, "com.google.android.gms.measurement.AppMeasurement", this.zzXE, true)) {
            try {
                obj = zzl(context, str).invoke(this.zzXE.get(), new Object[0]);
            } catch (Exception e) {
                zza(e, str, true);
            }
        }
    ...
    private final void zza(Context context, String str, String str2) {
        if (zza(context, "com.google.android.gms.measurement.AppMeasurement", this.zzXE, true)) {
            try {
                ...
                zzafr.m1217v(valueOf.length() != 0 ? str3.concat(valueOf) : new String(str3));
            } catch (Exception e) {
                zza(e, str2, false);
            }
        }
    ...
    private final void zza(Exception exception, String str, boolean z) {
        if (!this.zzXC.get()) {
            zzajc.zzc(new StringBuilder(String.valueOf(str).length() + 30).append("Invoke Firebase method ").append(str).append(" error.").toString(), exception);
            if (z) {
    ...
    private final Method zzx(Context context) {
        ...
        try {
            ...
            this.zzXG.put("logEventInternal", method);
            return method;
        } catch (Exception e) {
            zza(e, "logEventInternal", true);
            return null;
    ...
    final /* synthetic */ String zzy(Context context) throws Exception {
        return (String) zza("getAppInstanceId", context);
    }
}
