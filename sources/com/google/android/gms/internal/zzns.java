...
public final class zzns extends zzpg implements zzob {
    ...
    public final void zzc(Bundle bundle) {
        synchronized (this.mLock) {
            if (this.zzHM == null) {
                zzajc.m1216e("Attempt to perform click before content ad initialized.");
                return;
            }
    ...
    public final boolean zzd(Bundle bundle) {
        ...
        synchronized (this.mLock) {
            if (this.zzHM == null) {
                zzajc.m1216e("Attempt to record impression before content ad initialized.");
                z = false;
            } else {
                z = this.zzHM.zzd(bundle);
            }
        }
        return z;
    }
    ...
    public final void zze(Bundle bundle) {
        synchronized (this.mLock) {
            if (this.zzHM == null) {
                zzajc.m1216e("Attempt to perform click before app install ad initialized.");
                return;
            }
