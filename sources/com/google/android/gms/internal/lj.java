...
public final class lj extends zza {
    ...
    public lj(@Nullable String str, @Nullable String str2, String str3, @Nullable String str4, @Nullable String str5) {
        ...
        if (!TextUtils.isEmpty(this.zzaln)) {
            stringBuilder.append("id_token=").append(this.zzaln).append("&");
        }
        if (!TextUtils.isEmpty(this.zzbCx)) {
            stringBuilder.append("access_token=").append(this.zzbCx).append("&");
        }
        if (!TextUtils.isEmpty(this.zzalO)) {
            stringBuilder.append("identifier=").append(this.zzalO).append("&");
        }
        if (!TextUtils.isEmpty(this.zzbXB)) {
            stringBuilder.append("oauth_token_secret=").append(this.zzbXB).append("&");
        }
        stringBuilder.append("providerId=").append(this.zzbVY);
