...
public final class zzvn implements NativeMediationAdRequest {
                ...
                if (str2.startsWith(str)) {
                    ...
                    if (split.length == 3) {
                        if (ServerProtocol.DIALOG_RETURN_SCOPES_TRUE.equals(split[2])) {
                            this.zzNh.put(split[1], Boolean.valueOf(true));
                        } else if ("false".equals(split[2])) {
                            this.zzNh.put(split[1], Boolean.valueOf(false));
                        }
                    }
                } else {
                    this.zztT.add(str2);
    ...
    public final boolean isContentAdRequested() {
        return this.zztT != null && this.zztT.contains(AppEventsConstants.EVENT_PARAM_VALUE_YES);
    }
