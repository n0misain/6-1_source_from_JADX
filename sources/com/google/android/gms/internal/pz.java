...
public final class pz implements Iterable<Entry<qr, xm>> {
    ...
    public static pz zzD(Map<String, Object> map) {
        ...
        for (Entry entry : map.entrySet()) {
            uvVar = uvVar.zza(new qr((String) entry.getKey()), new uv(xp.zza(entry.getValue(), xd.zzJb())));
        }
        return new pz(uvVar);
    }
    ...
    public static pz zzE(Map<qr, xm> map) {
        ...
        uv uvVar = zzHR;
        for (Entry entry : map.entrySet()) {
            uvVar = uvVar.zza((qr) entry.getKey(), new uv((xm) entry.getValue()));
        }
        return new pz(uvVar);
    }
    ...
    public final pz zze(qr qrVar, xm xmVar) {
        ...
        if (zzF != null) {
            ...
            wp zzHf = zza.zzHf();
            if (zzHf != null && zzHf.zzIN() && xmVar2.zzN(zza.zzHe()).isEmpty()) {
                return this;
            }
            return new pz(this.zzccG.zzb(zzF, xmVar2.zzl(zza, xmVar)));
        }
