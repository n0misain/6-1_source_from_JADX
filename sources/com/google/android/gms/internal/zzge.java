    ...
    private final void zze(View view) {
        ...
        if (this.zzxb != null) {
            try {
                ...
                zzajc.zzb("Failed trying to unregister the receiver", e22);
            } catch (Throwable e222) {
                zzbs.zzbD().zza(e222, "ActiveViewUnit.stopScreenStatusMonitoring");
            }
            this.zzxb = null;
        }
        if (this.zzxz != null) {
            try {
                ...
                zzajc.zzb("Error registering activity lifecycle callbacks.", e2222);
            }
        }
    }
