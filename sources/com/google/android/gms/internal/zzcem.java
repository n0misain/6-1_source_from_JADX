...
public final class zzcem extends zzchi {
    ...
    public final long zza(String str, zzcfc<Long> zzcfc) {
        ...
        Object zzM = super.zzwC().zzM(str, zzcfc.getKey());
        if (TextUtils.isEmpty(zzM)) {
            return ((Long) zzcfc.get()).longValue();
        }
        try {
            return ((Long) zzcfc.get(Long.valueOf(Long.valueOf(zzM).longValue()))).longValue();
    ...
    public final int zzb(String str, zzcfc<Integer> zzcfc) {
        ...
        try {
            return ((Integer) zzcfc.get(Integer.valueOf(Integer.valueOf(zzM).intValue()))).intValue();
        } catch (NumberFormatException e) {
            return ((Integer) zzcfc.get()).intValue();
        }
    }
    ...
    public final boolean zzdO(String str) {
        return AppEventsConstants.EVENT_PARAM_VALUE_YES.equals(super.zzwC().zzM(str, "gaia_collection_enabled"));
    }
