...
public final class zzbak extends zza {
    ...
    public final String toString() {
        ...
        stringBuilder.append("packageVersionCode=").append(this.zzazj).append(',');
        stringBuilder.append("logSource=").append(this.zzazl).append(',');
        stringBuilder.append("logSourceName=").append(this.zzazk).append(',');
        stringBuilder.append("uploadAccount=").append(this.zzazm).append(',');
        stringBuilder.append("loggingId=").append(this.zzazn).append(',');
        stringBuilder.append("logAndroidId=").append(this.zzazU).append(',');
        stringBuilder.append("isAnonymous=").append(this.zzazo).append(',');
        stringBuilder.append("qosTier=").append(this.zzazp);
