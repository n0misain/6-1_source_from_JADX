...
final class tf implements om, td {
    ...
    public final oc zzGa() {
        ...
        List arrayList = new ArrayList(zzFR.size());
        for (qr zzHb : zzFR) {
    ...
    public final List<? extends vk> zzb(DatabaseError databaseError) {
        if (databaseError == null) {
            ...
            zza.zze(new StringBuilder((String.valueOf(valueOf).length() + 19) + String.valueOf(valueOf2).length()).append("Listen at ").append(valueOf).append(" failed: ").append(valueOf2).toString(), null);
