...
public final class zzlc {
    ...
    public final void zza(zzla zzla) {
        try {
            if (this.zzBg == null) {
                ...
                zziv zza = zza(context, this.zzAy, this.zzBj);
                this.zzBg = "search_v2".equals(zza.zzAs) ? (zzjz) zziz.zza(context, false, new zzjb(zzji.zzdt(), context, zza, this.zztV)) : (zzjz) zziz.zza(context, false, new zzja(zzji.zzdt(), context, zza, this.zztV, this.zzBb));
    ...
    public final boolean zza(zzjz zzjz) {
        ...
        try {
            ...
            if (((View) zzn.zzE(zzal)).getParent() != null) {
                return false;
            }
            this.zzBi.addView((View) zzn.zzE(zzal));
            this.zzBg = zzjz;
    ...
    public final zzks zzae() {
        ...
        if (this.zzBg != null) {
            try {
                zzks = this.zzBg.getVideoController();
            } catch (Throwable e) {
