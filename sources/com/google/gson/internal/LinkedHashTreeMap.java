...
public final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new C09111();
    ...
    static class C09111 implements Comparator<Comparable> {
        C09111() {
        }
    ...
    final class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C09121 extends LinkedTreeMapIterator<Entry<K, V>> {
            C09121() {
                super();
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C09131 extends LinkedTreeMapIterator<K> {
            C09131() {
                super();
            }
