...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new C09141();
    ...
    static class C09141 implements Comparator<Comparable> {
        C09141() {
        }
    ...
    class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C09151 extends LinkedTreeMapIterator<Entry<K, V>> {
            C09151() {
                super();
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C09161 extends LinkedTreeMapIterator<K> {
            C09161() {
                super();
            }
