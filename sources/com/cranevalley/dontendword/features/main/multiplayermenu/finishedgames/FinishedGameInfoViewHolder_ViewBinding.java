...
public class FinishedGameInfoViewHolder_ViewBinding<T extends FinishedGameInfoViewHolder> implements Unbinder {
    protected T target;

    @UiThread
    public FinishedGameInfoViewHolder_ViewBinding(T target, View source) {
        this.target = target;
        ...
        target.resultTextView = (AppCompatTextView) Utils.findRequiredViewAsType(source, C0521R.id.resultTextView, "field 'resultTextView'", AppCompatTextView.class);
    }
